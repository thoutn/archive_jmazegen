...
//
//        // Kruskal's algo
//        timeIt_ = new TimeIt(new Old4KruskalsMazeBuilder(), 20, 20);
//        System.out.println("Kruskal's algo: " +  Arrays.toString(timeIt_.timeIt(100, 5)));
//
//        grid = new Grid(10, 10);
//        OldKruskalsMazeBuilder kruskals = new OldKruskalsMazeBuilder(grid);
//        kruskals.buildMaze();
//
...
//            put("Recursive Backtracker", new RecursiveBacktrackerMazeBuilder());
            put("Old22Prim's", new Old2Prims());
            put("Prim's", new Prims());
//            put("Old Kruskal's", new OldKruskalsMazeBuilder());
//            put("Old2Kruskal's", new Old2KruskalsMazeBuilder());
//            put("Old3 Kruskal's", new Old3KruskalsMazeBuilder());
...
//            put("Recursive Division", new RecursiveDivisionMazeBuilder());
        ...
        stats.writeToFile("stats_prims23.txt");
    }
}
